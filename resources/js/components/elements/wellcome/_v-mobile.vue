<template>
    ...
    <section class="my-account-area section-space v-mobile">
        <div class="container">
                ...
                <div class="col-12" style="margin-top: 20px">
                    <div class="accordion" id="FaqAccordion">
                        <div class="accordion-item">
                            ...
                            <div id="collapse1" class="accordion-collapse" aria-labelledby="heading1" data-bs-parent="#FaqAccordion">
                                        ...
                                        <div class="myaccount-table text-center">
                                            <table class="table ">
                                                ...
                                                <tr v-for="(order, key) in orders">
                                                    ...
                                                    <td class="order-status">{{order.status === 0 ? 'Новий' : order.status ===1 ? 'Виконується' : 'Виконаний'}}</td>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#FaqAccordion">
                                <div ref="start" class="accordion-body">
                                    <div class="myaccount-content">
                                        ...
                                        <div class="account-details-form">
                                            <form action="#">
                                                ...
                                                <div class="form-group mb-6 dropzone-box">
                                                    ...
                                                    <div class="col-11 img-preview text-center">
                        ...
                        <div class="accordion-item">
                            <h2 ref="startPassword" class="accordion-header" id="heading6">
                        ...
                        <button @click="logout" class="btn nav-link"  type="button">Вихід</button>
                    </div>
                </div>
            </div>
            <!--            <div class="row">
