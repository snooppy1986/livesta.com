...
Route::group(['middleware'=>['web', 'admin.role:Admin,Manager'],'prefix'=>'admin'], function ($router){
    ...
    Route::post('product/update/{id}', [ProductController::class, 'update'])->name('product.edit.action');
    ...
    Route::get('options/main-slider/edit/{id}', [MainSliderController::class, 'edit'])->name('main-slider.edit');
